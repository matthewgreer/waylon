...
const drawWaylon = (x, y, scale) => {
  ...
  // layer1/Waylonbelly/light underside fill
  ctx.save();
  ctx.beginPath();
  ...
  // layer1/Waylonbelly/bottom shadow
  ctx.beginPath();
  ctx.moveTo(x + 226 * scale, y + 157 * scale);
  ctx.bezierCurveTo(
    x + 228 * scale,
    y + 159 * scale,
    x + 257 * scale,
  ...
  // layer1/Waylonbelly/mid shadow
  ctx.beginPath();
  ctx.moveTo(x + 223 * scale, y + 150 * scale);
  ctx.bezierCurveTo(
    x + 320 * scale,
    y + 153 * scale,
    x + 371 * scale,
  ...
  // layer1/Waylonbelly/top shadow
  ctx.beginPath();
  ctx.moveTo(x + 235 * scale, y + 123 * scale);
  ctx.bezierCurveTo(
    x + 248 * scale,
    y + 130 * scale,
    x + 287 * scale,
